...
|--------|--------|-------------|
| `Ctrl+Cmd+H` | Snap Left | Snap window to the left half of the screen |
| `Ctrl+Cmd+L` | Snap Right | Snap window to the right half of the screen |
| `Ctrl+Cmd+K` | Snap Top | Snap window to the top half of the screen |
| `Ctrl+Cmd+J` | Snap Bottom | Snap window to the bottom half of the screen |
