...
class TestOnEnhanceEditConfig:
    @patch("voicetext.config_controller.subprocess.Popen")
    ...
    @patch("voicetext.config_controller.subprocess.Popen", side_effect=Exception("fail"))
...
class TestLogLevelChange:
    @patch("voicetext.config_controller.save_config")
...
class TestBuildConfigInfo:
    @patch("voicetext.config_controller.PRESET_BY_ID", {"funasr-zh": MagicMock(display_name="FunASR 中文")})
    ...
    @patch("voicetext.config_controller.PRESET_BY_ID", {})
...
class TestOnReloadConfig:
    @patch("voicetext.config_controller.send_notification")
    @patch("voicetext.config_controller.load_config")
    ...
    @patch("voicetext.config_controller.send_notification")
    @patch("voicetext.config_controller.load_config", side_effect=Exception("bad config"))
...
class TestOnBrowseHistory:
    def test_creates_browser_and_shows(self, ctrl, mock_app):
        with patch("voicetext.history_browser_window.HistoryBrowserPanel") as mock_cls:
...
class TestOnAbout:
    @patch("voicetext.config_controller.restore_accessory")
    @patch("voicetext.config_controller.topmost_alert")
