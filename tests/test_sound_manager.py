...
from voicetext.sound_manager import SoundManager, ensure_start_sound
...
class TestSoundManagerPlay:
    @patch("voicetext.sound_manager.SoundManager._play_on_main_thread")
...
class TestEnsureStartSound:
    def test_generates_wav_in_sounds_dir(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("voicetext.sound_manager.SOUNDS_DIR", sounds_dir)
