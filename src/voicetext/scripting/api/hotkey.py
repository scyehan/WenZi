...
from voicetext.scripting.registry import LeaderConfig, LeaderMapping, ScriptingRegistry
...
class HotkeyAPI:
    ...
    def _start_leader_listener(self) -> None:
        ...
        from voicetext.hotkey import _QuartzAllKeysListener
    ...
    def _start_hotkey_listeners(self) -> None:
        ...
        from voicetext.hotkey import TapHotkeyListener
    ...
    def _execute_mapping(self, mapping: LeaderMapping) -> None:
        ...
        try:
            if mapping.app:
                ...
                from voicetext.scripting.api.execute import execute
